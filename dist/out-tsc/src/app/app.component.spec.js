...
var firestore_mock_service_1 = require("./shared/firebase-mock/firestore-mock/firestore-mock.service");
var auth_1 = require("@angular/fire/auth");
var router_1 = require("@angular/router");
var router_mock_1 = require("./shared/route-stub/router-mock");
describe('AppComponent', function () {
    var statusBarSpy, splashScreenSpy, platformReadySpy, platformSpy, angularFireAuthSpy;
    beforeEach(testing_1.async(function () {
        ...
        testing_1.TestBed.configureTestingModule({
            ...
            providers: [
                ...
                { provide: auth_1.AngularFireAuth, useValue: angularFireAuthSpy },
