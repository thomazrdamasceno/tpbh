...
var StatePage = /** @class */ (function () {
    function StatePage(storage) {
        this.storage = storage;
        this.options = [
            { header: 'Novo', value: 'new' },
            { header: 'Usado', value: 'used' }
        ];
        this.product = new Product_model_1.Product();
    }
    StatePage.prototype.ngOnInit = function () {
        var _this = this;
...
exports.StatePage = StatePage;
//# sourceMappingURL=state.page.js.map