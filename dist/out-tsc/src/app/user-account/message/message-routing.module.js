...
var routes = [
    ...
    {
        path: 'list', loadChildren: './message-list/message-list.module#MessageListPageModule'
    }, {
        path: 'detail/:groupId', loadChildren: './message-detail/message-detail.module#MessageDetailPageModule'
    }
];
