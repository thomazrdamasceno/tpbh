...
var routes = [
    {
        path: '',
        component: configuration_page_1.ConfigurationPage
    }
];
var ConfigurationPageModule = /** @class */ (function () {
    ...
    ConfigurationPageModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [configuration_page_1.ConfigurationPage]
        })
    ], ConfigurationPageModule);
    return ConfigurationPageModule;
}());
exports.ConfigurationPageModule = ConfigurationPageModule;
